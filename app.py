...
def generate_docx(sections, data):
    ...
    # Footer
    footer_para = doc.add_paragraph('Generated using Biochar PDD Generator | Puro.earth Aligned | For review purposes only')
...
with col2:
    developer = st.text_input("Project Developer / Company", placeholder="e.g. RenewCred Pvt Ltd")
    start_date = st.date_input("Project Start Date")
    registry = st.selectbox("Registry / Standard", ["Puro.earth", "EBC (European Biochar Certificate)", "Verra (VCS)"])
